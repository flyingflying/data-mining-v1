...
from core.algorithms import TextRankKeywords, JioKeyphrases
...
if __name__ == "__main__":
    extract_keywords = TextRankKeywords()
    
    extract_keyphrases_v0 = JioKeyphrases()
    extract_keyphrases_v15 = JioKeyphrases(word_weights_file_name="lda_15_word_weights.json", idf_file_name="specified_idf.json")
    extract_keyphrases_v50 = JioKeyphrases(word_weights_file_name="lda_50_word_weights.json", idf_file_name="specified_idf.json")
    
    documents = [document1, document2]
    
    for document in documents:
        print(extract_keywords(document))
        print(extract_keyphrases_v0(document, top_k=10, return_scores=True))
        print(extract_keyphrases_v15(document, top_k=10, return_scores=True))
        print(extract_keyphrases_v50(document, top_k=10, return_scores=True))
